...
# sleep 5
# python step_myprm_qwen.py --load_path "" --special_tokens --model_type token --reward_model Qwen/Qwen3-8B
# sleep 5
...
# python step_myprm_qwen.py --load_path "" --model_type clf --reward_model Qwen/Qwen3-8B
# sleep 5
