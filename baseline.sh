...
# sleep 2
python step_myprm_qwen.py --load_path weights/whole-sky-243 --peft_rank 16 --lora_dropout 0 --add_new_token --model_type classifier --reward_model Qwen/Qwen2.5-Math-7B-Instruct
sleep 2
...
# sleep 2
python step_myprm_qwen.py --load_path weights/leafy-morning-242 --peft_rank 16 --lora_dropout 0 --add_new_token --model_type token --reward_model Qwen/Qwen2.5-Math-7B-Instruct
sleep 2
...
# sleep 2
python step_myprm_qwen.py --load_path weights/elated-cosmos-198 --peft_rank 16 --lora_dropout 0 --special_tokens  --model_type token --reward_model Qwen/Qwen2.5-Math-7B-Instruct --freeze_all_but_bias
sleep 2
...
# sleep 2
python step_myprm_qwen.py --load_path weights/tough-moon-199 --peft_rank 16 --lora_dropout 0 --model_type classifier --reward_model Qwen/Qwen2.5-Math-7B-Instruct --freeze_all_but_bias
sleep 2
...
# sleep 5
python step_myprm_qwen.py --load_path "" --special_tokens --model_type token --reward_model Qwen/Qwen2.5-Math-7B-Instruct
sleep 5
...
# sleep 5
python step_myprm_qwen.py --load_path "" --model_type clf --reward_model Qwen/Qwen2.5-Math-7B-Instruct
sleep 5
...
python step_prm_qwen_benchmark.py
...
python step_prm_qwen_benchmark.py --load_path "weights/denim-meadow-236/Output-Qwen-Qwen2.5-Math-7B-Instruct/checkpoint-163384"
...
# sleep 5
python step_prm_qwen_benchmark.py --load_path "" --special_tokens --model_type token --reward_model Qwen/Qwen3-8B
sleep 5
...
python step_prm_qwen_benchmark.py --load_path "" --model_type clf --reward_model Qwen/Qwen3-8B
sleep 5
