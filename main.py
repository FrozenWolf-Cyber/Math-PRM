...
upper = Upper(name="upper", config=upper_config, ddp_check_parameters=False, extra_config={"resume_step_from": None}) #args.resume_from_step if args.resume_from_step != -1 else None})
lower = Lower(name="lower", config=lower_config, ddp_check_parameters=False, extra_config={"resume_step_from": None}) #args.resume_from_step if args.resume_from_step != -1 else None})
